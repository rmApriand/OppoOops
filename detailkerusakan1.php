    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="index.html" class="flex items-center">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">OppoOops <span class="bg-gray-100 text-gray-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">Beta</span></span>
            </a>
            ...
            <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
              <div class="col-sm-10">
                <?php
                  ...
                  while ($data = mysqli_fetch_array($sql)) {
                    echo "<textarea rows='8' class='w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400' readonly>".$data['caramengatasi']."</textarea><br>";

                    $youtubeLink = $data['linktutorial'];
                    $videoId = '';

                    if (strpos($youtubeLink, 'youtu.be/') !== false) {
                        $videoId = explode("youtu.be/", $youtubeLink)[1];
                        $videoId = explode("?", $videoId)[0];
                    } elseif (strpos($youtubeLink, 'watch?v=') !== false) {
                        parse_str(parse_url($youtubeLink, PHP_URL_QUERY), $youtubeParams);
                    ...
                    if ($videoId) {
                        ...
                        <div class='mt-4'>
                          ...
                          <a href='https://www.youtube.com/watch?v=$videoId' target='_blank' class='inline-block rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600'>
                            <img src='$thumbnail' alt='Thumbnail YouTube' class='w-full h-auto'>
                          </a>
                        </div>";
                    } else {
                        echo "<p class='text-sm text-red-500 mt-2'>Link YouTube tidak valid.</p>";
                    }
                  }
                ?>
              </div>
