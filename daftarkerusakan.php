...
<div class="container-fluid">
  ...
  <br>
  <a href="inputkerusakan.php" class="btn btn-success mb-3">
  ...
  <div class="box-body table-responsive">
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tbody>
        <?php
          if (isset($_POST['hp']) && $_POST['hp'] != "jenishp") {
            ...
            while ($data = mysqli_fetch_array($hasil)) {
              ...
              echo "
                <tr>
                  ...
                  <td>{$data[2]}</td>
                  <td>
                    <a href='detailkerusakan.php?id={$data[0]}' title='Detail'><i class='bi bi-search text-primary'></i></a>
                    <a href='editkerusakan.php?id={$data[0]}' title='Edit'><i class='bi bi-pencil text-warning ms-2'></i></a>
                    <a href='deletekerusakan.php?id={$data[0]}' onclick='return checkDelete()' title='Hapus'><i class='bi bi-trash3 text-danger ms-2'></i></a>
                  </td>
                </tr>";
            }
          }
