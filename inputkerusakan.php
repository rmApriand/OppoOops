    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form class="form-horizontal" method="post" data-toggle="validator" role="form" action="inputkerusakan.php">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select class="form-control" name="jenishp">
              <option>Pilih</option>
              <option>Oppo</option>
        ...
        <!-- Tambahan kolom link YouTube -->
        <div class="form-group">
          <label class="control-label col-sm-2" for="youtube">Link Video Tutorial:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" name="linktutorial" placeholder="Contoh: https://youtu.be/abc123">
          </div>
        </div>
