...
<div class="container-fluid">
  <div class="row">
    ...
    <form method="post">
      <div class="form-group">
          ...
          <div class="col-sm-10">
              ...
              while($data = mysqli_fetch_array($sql)) {
                  echo "<input type='text' name='idkerusakan' class='form-control' id='idkerusakan' disabled value='".$data['idkerusakan']."'><br>";
              }
              ?>
          </div>
      </div>
      ...
      <div class="form-group">
          <label class="control-label col-sm-2">Jenis Smartphone:</label>
          <div class="col-sm-10">
              <?php
              $tampil = "SELECT * FROM kerusakan WHERE idkerusakan='".$_GET['id']."'";
              $sql = mysqli_query($konek_db, $tampil);
      ...
      <div class="form-group">
          ...
          <div class="col-sm-10">
              ...
              $sql = mysqli_query($konek_db, $tampil);
              while($data = mysqli_fetch_array($sql)) {
                  echo "<textarea class='form-control' id='caramengatasi' name='caramengatasi'>".$data['caramengatasi']."</textarea><br>";
              }
              ?>
          </div>
      </div>
      ...
      <div class="form-group">
          <label class="control-label col-sm-2">Link Tutorial:</label>
          <div class="col-sm-10">
              <?php
              $tampil = "SELECT * FROM kerusakan WHERE idkerusakan='".$_GET['id']."'";
              $sql = mysqli_query($konek_db, $tampil);
              while($data = mysqli_fetch_array($sql)) {
                  echo "<input type='text' class='form-control' id='linktutorial' name='linktutorial' value='".$data['linktutorial']."'><br>";
              }
              ?>
          </div>
      </div>
      ...
      if (isset($_POST['submit'])) {
          ...
          $linktutorial = $_POST['linktutorial'];

          $query = "UPDATE kerusakan SET 
