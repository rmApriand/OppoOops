          ...
          <div class="form-group" method="POST">
            ...
            <div class="col-sm-10">
              <?php
                ...
                while ($data = mysqli_fetch_array($sql)) {
                  echo "<textarea rows='8' class='form-control mb-3' id='penanganan' readonly>" . $data['caramengatasi'] . "</textarea>";
                  ...
                  if ($videoId) {
                      ...
                      echo "
                      <div class='mb-3'>
                        <label class='control-label d-block mb-2'>Video Tutorial:</label>
                        <a href='https://www.youtube.com/watch?v=$videoId' target='_blank' style='display: block; max-width: 100%;'>
                          <img src='$thumbnail' alt='Thumbnail YouTube' class='img-fluid'>
                        </a>
                      </div>";
                  } else {
                      echo "<p class='text-danger mt-2'>Link YouTube tidak valid.</p>";
                  }
                }
              ?>
            </div>
